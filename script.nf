 ...
 */
    ...
    file("${h5_file.baseName}_top10_variablefeatures.png")
    file("${h5_file.baseName}_dimplot.png")
    file("${h5_file.baseName}_heatmap.png")
    file("${h5_file.baseName}_output.csv")
    file("${h5_file.baseName}_dimplot_cell_cycle.png")
    file("${h5_file.baseName}_feature_cell_cycle.png")
    file("${h5_file.baseName}_violin_cell_cycle.png")
    file("${h5_file.baseName}_monaco_dimplot.png")
    file("${h5_file.baseName}_hpca_dimplot.png")
    file("${h5_file.baseName}_dice_dimplot.png")
